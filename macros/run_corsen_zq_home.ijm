...
//    run("3D Viewer");
    ...
    run("3D Objects Counter", "threshold=5 slice=5 min.=1 max.=1134972 statistics"); 
    if (nResults == 0) {
        return;
    }
}
...
//  image_in = "/home/zqiu/Desktop/Link to project/NanoChop/data/Jacob/13-7-24/100nm Bleach ND 0 50ms exposure 30mins 30s interval/100nm Bleach ND 0 50ms exposure 30mins 30s interval_MMImages.ome.tif"
 // image_in = "/home/zqiu/Desktop/Link to project/HBP/melissa/W1F070T0001Z_C1.tif";
  image_in = "/home/zqiu/Desktop/Link to project/HBP/melissa/0_0_stack.tif";
  output =  "/home/zqiu/Desktop/Link to project/HBP/melissa/out_out_0_0_.tif";
  coeff = 1.0;
  median = "1";
  conti = "0";
  min = "6000";
  ...
  mask1 = "Mean";
  mask2 = "Otsu";
  prepend_cols = "GKD229	5	1	corsenpreproc1_cf1.0_m1_ct0_mn6000_mx20000_m1Mean_m2Otsu	1	1";
  process_stack(image_in, output, prepend_cols,coeff, median, conti, min, max, mask1, mask2);
}
